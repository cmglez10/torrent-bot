               ...
               return telegramBot.sendMessage(config.userId, templater.build(data.type, data),
                  {
                     ...
                     reply_markup: {
                        inline_keyboard: [
                           [{text: "Descargar", callback_data: ' at Promise._settlePromiseAt (/home/leader/www/torrent-bot/node_modules/node-telegram-bot-api/node_modules/request-promise/node_modules/blu'}]
                        ]
                     }
                  })
            })
